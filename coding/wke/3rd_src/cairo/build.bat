...
rem set COMPILER=cl /nologo /MD /Od /Zi /W3 /c /TC /DPIXMAN_NO_TLS /D_CRT_SECURE_NO_DEPRECATE /DCAIRO_WIN32_STATIC_BUILD /DDISABLE_SOME_FLOATING_POINT -DPACKAGE=pixman-1 -DPACKAGE_VERSION="" -DPACKAGE_BUGREPORT="" /I src /I pixman /I ../libpng /I ../zlib /wd 4146 /wd 4244 /wd 4996 /wd 4819 /wd 4700
set COMPILER=cl /nologo /MD /O2 /W3 /c /TC /DPIXMAN_NO_TLS /D_CRT_SECURE_NO_DEPRECATE /DCAIRO_WIN32_STATIC_BUILD /DDISABLE_SOME_FLOATING_POINT -DPACKAGE=pixman-1 -DPACKAGE_VERSION="" -DPACKAGE_BUGREPORT="" /I src /I pixman /I ../libpng /I ../zlib /wd 4146 /wd 4244 /wd 4996 /wd 4819 /wd 4700
