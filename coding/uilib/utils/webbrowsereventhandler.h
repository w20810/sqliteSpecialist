...
namespace UiLib
{
	...
	public:
		...
		virtual LRESULT OnIEWndKillFocus(UINT uMsg, WPARAM wParam, LPARAM lParam)
		{
			return FALSE;
		}

		virtual LRESULT OnIEWndLButtonDown(UINT uMsg, WPARAM wParam, LPARAM lParam)
		{
			return FALSE;
		}

		virtual LRESULT OnIEWndLButtonUp(UINT uMsg, WPARAM wParam, LPARAM lParam)
		{
			return FALSE;
		}

		virtual LRESULT OnIEWndMouseMove(UINT uMsg, WPARAM wParam, LPARAM lParam)
		{
			return FALSE;
		}

		virtual LRESULT OnIEWndKeyDown(UINT uMsg, WPARAM wParam, LPARAM lParam)
		{
			return FALSE;
		}
