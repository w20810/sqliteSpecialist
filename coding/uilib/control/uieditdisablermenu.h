#ifndef __UIEDITDISABLERMENU_H__
#define __UIEDITDISABLERMENU_H__

#pragma once

namespace UiLib
{
	class CEditDisableRMenuWnd;

	class UILIB_API CEditDisableRMenuUI : public CLabelUI
	{
		friend class CEditDisableRMenuWnd;
	public:
		CEditDisableRMenuUI();
	...
	protected:
		UINT m_uDelay;
		CEditDisableRMenuWnd*	m_pWindow;
		bool		m_bEnableTime;
...
#endif // __UIEDITDISABLERMENU_H__