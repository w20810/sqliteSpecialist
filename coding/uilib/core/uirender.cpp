            ...
            case _T('a'):  // Link
                {
                    ...
                    if( pFontInfo->bUnderline == false ) {
                        ...
                        cyLine = MAX((LONG)cyLine, pTm->tmHeight + pTm->tmExternalLeading + (int)aPIndentArray.GetAt(aPIndentArray.GetSize() - 1));
                    }
                    ptLinkStart = pt;
                    bInLink = true;
                }
            ...
            case _T('p'):  // Paragraph
                {
                    ...
                    cyLine = MAX((LONG)cyLine, pTm->tmHeight + pTm->tmExternalLeading + cyLineExtra);
                }
                break;
            case _T('r'):  // Raw Text
                {
