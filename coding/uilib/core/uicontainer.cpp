...
//			m_pHorizontalScrollBar->SetVisible(false);    //这里被修改了  Redrain
	...
	CControlUI* CContainerUI::FindSubControlByIndex( int nSubControlIndex )
	{
		CControlUI* pSubControl=NULL;
		pSubControl=static_cast<CControlUI*>(GetManager()->FindSubControlByIndex(this,nSubControlIndex));
		return pSubControl;
	}
