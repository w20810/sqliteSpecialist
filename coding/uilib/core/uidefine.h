...
#define DUI_MSGTYPE_CANCLESELECTED			(_T("cancleselected"))
#define DUI_MSGTYPE_HEADWIDTHCHANGED		(_T("headerwidthchanged"))

#define DUI_MSGTYPE_CTLWND_KILLFOCUS		(_T("ctlwndkillfocus"))
...
#define  DUI_CTR_EDITDISABLERMENU                (_T("EditDisableRMenu"))
#define  DUI_CTR_LIST                            (_T("List"))
#define  DUI_CTR_DYNAMICLIST                     (_T("DynamicList"))
...
#define  DUI_CTR_OPTIONEX                        (_T("OptionEx"))
...
#define  DUI_CTR_HORIZONTALLAYOUTFUNC            (_T("HorizontalLayoutFunc"))
