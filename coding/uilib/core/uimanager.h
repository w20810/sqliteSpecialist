...
/////////////////////////////////////////////////////////////////////////////////////
//
#define WM_EFFECTS		WM_APP+1680
#define WM_RELOADSTYLE	WM_APP+1681
...
public:
	...
	int GetStrFixedWidth(CDuiString duiStr);

    static HINSTANCE GetInstance();
    static CDuiString GetInstancePath();
	static CDuiString GetInstanceApp();
	...
	static void ReloadStyle(CDuiString sStyleXml = _T("style.xml"));
    static bool LoadPlugin(LPCTSTR pstrModuleName);
    static CStdPtrArray* GetPlugins();

	static bool CreateDir(LPCTSTR path, bool bRelative);
	...
	CControlUI* FindSubControlByIndex(CControlUI* pParent, int nIndex) const;
...
private:
	...
	static CControlUI* CALLBACK __FindControlFromIndex(CControlUI* pThis, LPVOID pData);
